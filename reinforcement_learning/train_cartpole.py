...
def train_online(
    ...
    tensorboard = tensorboard_evaluation.Evaluation(
    ...
    for i in range(num_episodes):
        print("episode: ", i)
        stats = run_episode(
            env, agent, deterministic=False, do_training=True, rendering=True
        )
...
if __name__ == "__main__":
    ...
    dqn = DQNAgent(
        Q_network, Q_target, num_actions, device=device, history_length=100000
    )
